...
const LeftSidebar = () => {
    ...
    return (
        <div className='w-[20%] mt-2'>
            <div>
                <div>
                    <img className='w-12 ml-2' src="https://img.freepik.com/free-vector/twitter-new-2023-x-logo-white-background-vector_1017-45422.jpg?w=740&t=st=1711900195~exp=1711900795~hmac=bac301e018a84f7190c845c594ff40136484cfc110e814932537874fdbe40e4a" alt=" twitter-logo" />
                </div>
                <div className='mt-4 mb-4'>
                    ...
                    <div onClick={logoutHandler} className='flex items-center mb-4 hover:bg-gray-100 cursor-pointer duration-300'>
                        <AiOutlineLogout />
                        <h3 className='font-bold text-red-700 text-lg ml-2'>Logout</h3>
                    </div>
                    <button className='w-48 h-10 text-white font-semibold bg-blue-500 rounded-3xl'>Post</button>
                </div>
            </div>
        </div>
    )
