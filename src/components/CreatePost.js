        ...
        <div>
            ...
            <div>
                <div className='flex items-center mt-4'>
                    <Avatar src="https://avatars.githubusercontent.com/u/102051680?s=400&u=2b436634eb2c3a96c5d1d80f28001895558f22c5&v=4" size="40" round={true} />
                    <input value={description} onChange={(e) => setDescription(e.target.value)} className='text-lg w-full outline-none border-none ml-2' type="text" placeholder='What is happening?' />
                </div>
                <div className='flex items-center justify-between my-4 border-b border-gray-300 p-1'>
                    ...
                    <button onClick={submitHandler} className='bg-blue-500 rounded-full w-16 h-8 text-white'>Post</button>
                </div>
            </div>
        </div>
    )
